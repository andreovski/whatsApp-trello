import { d as defaultNoteTemplates, s as saveNoteTemplates, a as getNoteTemplates, b as saveTrelloConfig, g as getTrelloConfig } from "./storage-CLrKxZkh.js";
...
function TrelloMark({ className }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      "aria-hidden": "true",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "24", height: "24", rx: "6", fill: "#026AA7" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "6", y: "5", width: "6.5", height: "12.5", rx: "2", fill: "#E4F0F6" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "14", y: "5", width: "5.8", height: "9.5", rx: "2", fill: "#6CC3FF" })
      ]
    }
  );
}
...
function CheckFileIcon({ className }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "svg",
    {
      width: "24",
    ...
    "svg",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "g",
        {
          ...
          strokeWidth: "2",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M21 12a9 9 0 0 0-9-9a9.75 9.75 0 0 0-6.74 2.74L3 8" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M3 3v5h5m-5 4a9 9 0 0 0 9 9a9.75 9.75 0 0 0 6.74-2.74L21 16" }),
...
function CheckTopicsIcon({ className }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "svg",
    {
      width: "24",
...
const classes = {
  primaryButton: "inline-flex items-center justify-center rounded-md bg-primary gap-2 px-4 py-2 font-semibold text-white transition hover:bg-primary-dark focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/60 disabled:cursor-not-allowed disabled:opacity-50",
  secondaryButton: "inline-flex items-center justify-center rounded-md bg-neutral-200 px-3 py-1 font-semibold text-neutral-700 transition-colors hover:bg-neutral-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 gap-2 dark:bg-white/10 dark:text-white dark:hover:bg-white/20",
  ghostCloseButton: "flex h-9 w-9 items-center justify-center rounded-lg text-lg text-neutral-500 transition hover:bg-neutral-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 dark:text-neutral-300 dark:hover:bg-primary/10",
  input: "rounded-md border border-black/15 bg-white px-3 py-2 text-sm text-neutral-900 outline-none transition focus:border-primary focus:ring-1 focus:ring-primary placeholder:text-neutral-500 placeholder:opacity-75 dark:border-white/20 dark:bg-neutral-900 dark:text-neutral-100 dark:placeholder:text-neutral-400 dark:placeholder:opacity-80 placeholder:font-normal disabled:cursor-not-allowed disabled:opacity-60",
  card: "flex rounded-xl p-4 bg-zinc-100 dark:bg-zinc-800"
};
const textareaClasses = `${classes.input} resize-y`;
function TrelloConfigForm({
  form,
  onChange,
  onSubmit,
  isSaving,
    ...
    "form",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-2 text-neutral-700 dark:text-neutral-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "API Key" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-2 text-neutral-700 dark:text-neutral-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Token" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-2 text-neutral-700 dark:text-neutral-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Board ID" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "flex flex-col gap-2 rounded-md border border-dashed border-primary/30 bg-primary/5 px-3 py-3 text-xs text-neutral-600 dark:border-primary/40 dark:bg-primary/10 dark:text-neutral-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-neutral-700 dark:text-neutral-200", children: "Templates de descrição" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Selecione um arquivo JSON local para atualizar os templates disponíveis na criação de card." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-md border border-dashed border-primary/30 bg-white px-3 py-2 text-xs text-neutral-600 shadow-sm dark:border-primary/40 dark:bg-neutral-900 dark:text-neutral-300", children: form.templateSourcePath ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-medium text-neutral-700 dark:text-neutral-100", children: [
              "Arquivo selecionado: ",
              form.templateSourcePath
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-neutral-500 dark:text-neutral-400", children: "Nenhum arquivo selecionado ainda." }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  ...
                  onChange: (event) => {
                    ...
                    if (file) {
                      onTemplateFileSelected == null ? void 0 : onTemplateFileSelected(file);
                    }
                    event.target.value = "";
                  }
                }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: "Selecionar arquivo local"
                }
              ),
              templateSourceLabel ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-neutral-500 dark:text-neutral-400", children: [
                "Origem atual: ",
                templateSourceLabel
              ] }) : null,
              typeof templateCount === "number" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-neutral-500 dark:text-neutral-400", children: [
                "Templates carregados: ",
                templateCount
              ] }) : null
            ] })
          ] }),
          templateImportStatus === "success" ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-primary", children: "Templates importados com sucesso!" }) : null,
          templateImportStatus === "loading" ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-primary", children: "Buscando templates..." }) : null,
          templateImportStatus === "error" && templateImportError ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-red-500", children: templateImportError }) : null
        ] }),
...
const useAppStore = create((set, get) => ({
  ...
  async saveNoteTemplates(templates) {
    try {
      await saveNoteTemplates(templates);
...
function createTemplate({ label, notes }) {
  ...
  const id2 = typeof (crypto == null ? void 0 : crypto.randomUUID) === "function" ? crypto.randomUUID() : `tpl-${Date.now()}-${Math.floor(Math.random() * 1e6)}`;
  return { id: id2, label: safeLabel, notes: safeNotes };
}
...
async function saveTemplateFileHandle(handle) {
  if (!handle) return;
  ...
  await new Promise((resolve, reject) => {
    ...
    tx.onabort = tx.onerror = () => {
      const error = tx.error || new Error("Falha ao salvar o handle do arquivo.");
      db2.close();
      reject(error);
    };
  });
}
async function getTemplateFileHandle() {
  const db2 = await openDatabase();
  return new Promise((resolve, reject) => {
    ...
    request.onerror = () => {
      const error = request.error || new Error("Falha ao recuperar o handle do arquivo.");
      db2.close();
      reject(error);
    };
    tx.onabort = tx.onerror = () => {
      const error = tx.error || new Error("Falha ao recuperar o handle do arquivo.");
      db2.close();
      reject(error);
    };
  });
}
async function clearTemplateFileHandle() {
  const db2 = await openDatabase();
  await new Promise((resolve, reject) => {
    const tx = db2.transaction(STORE_NAME, "readwrite");
    const store = tx.objectStore(STORE_NAME);
    ...
    tx.onabort = tx.onerror = () => {
      const error = tx.error || new Error("Falha ao limpar o handle do arquivo.");
      db2.close();
      reject(error);
    };
  });
}
const TrelloContext = reactExports.createContext(null);
...
function TrelloProvider({ children }) {
  ...
  const saveNoteTemplates2 = useStore((state) => state.saveNoteTemplates);
  ...
  const lastListsFetchKeyRef = reactExports.useRef(null);
  const listsCacheRef = reactExports.useRef([]);
  const { schedule: scheduleIdleReset, dispose: disposeIdleReset } = reactExports.useMemo(
    () => scheduleIdleResetFactory(setStatus),
    [setStatus]
  );
  const isConfigReady = reactExports.useMemo(
    () => Boolean((config == null ? void 0 : config.apiKey) && (config == null ? void 0 : config.apiToken) && (config == null ? void 0 : config.boardId)),
    [config == null ? void 0 : config.apiKey, config == null ? void 0 : config.apiToken, config == null ? void 0 : config.boardId]
  );
  const fetchLists = reactExports.useCallback(
    async ({ force = false } = {}) => {
      if (!(config == null ? void 0 : config.apiKey) || !(config == null ? void 0 : config.apiToken) || !(config == null ? void 0 : config.boardId)) {
      ...
      try {
        ...
        if (!(response == null ? void 0 : response.ok)) {
          throw new Error(
            (response == null ? void 0 : response.error) ?? "Falha ao carregar listas do Trello."
          );
        }
  ...
  const refreshLists = reactExports.useCallback(
    ({ force = true } = {}) => fetchLists({ force }),
    [fetchLists]
  );
  const createCard = reactExports.useCallback(
    async ({
      title,
      summary,
      recentMessages,
      ...
      if (!listId) {
        const message = "Selecione uma lista válida antes de criar o card no Trello.";
        setError(message);
        setStatus("error");
        scheduleIdleReset();
      ...
      try {
        ...
        if (!(response == null ? void 0 : response.ok)) {
          throw new Error((response == null ? void 0 : response.error) ?? "Erro desconhecido ao criar card");
        }
        if (listId) {
  ...
  const getRecentCards = reactExports.useCallback(async ({ limit = 5, listId } = {}) => {
    try {
      const response = await chrome.runtime.sendMessage({
      ...
      if (!(response == null ? void 0 : response.ok)) {
        throw new Error(
          (response == null ? void 0 : response.error) ?? "Falha ao carregar os cards recentes do Trello."
        );
      }
  ...
  const setPreferredList = reactExports.useCallback(
    async (listId) => {
      if (!listId) return;
      try {
        await saveConfig({ lastListId: listId });
  ...
  const ensureTemplateFileHandle = reactExports.useCallback(async () => {
    if ((config == null ? void 0 : config.templateSourceType) !== "file") {
      throw new Error(
  ...
  const persistTemplatesToFile = reactExports.useCallback(
    async (templates) => {
...
`;
        ...
        let fileName = (config == null ? void 0 : config.templateSourcePath) || "templates.json";
        try {
          const file = await handle.getFile();
          fileName = file.name || fileName;
        } catch (error2) {
          console.warn("Não foi possível obter o nome do arquivo", error2);
        }
        await saveConfig({
          templateSourceUpdatedAt: (/* @__PURE__ */ new Date()).toISOString(),
    ...
    [config == null ? void 0 : config.templateSourcePath, ensureTemplateFileHandle, saveConfig]
  );
  const createTemplate$1 = reactExports.useCallback(
    async ({ label, notes }) => {
      try {
        const template = createTemplate({ label, notes });
        const currentTemplates = Array.isArray(noteTemplates) ? [...noteTemplates, template] : [template];
        await persistTemplatesToFile(currentTemplates);
        await saveNoteTemplates2(currentTemplates);
        return { ok: true, template };
      } catch (error2) {
        console.error("Erro ao criar template", error2);
        return {
          ok: false,
          error: (error2 == null ? void 0 : error2.message) ?? "Falha ao criar template."
        };
      }
    },
    [noteTemplates, persistTemplatesToFile, saveNoteTemplates2]
  );
  ...
  reactExports.useEffect(() => () => disposeIdleReset(), [disposeIdleReset]);
  const value = reactExports.useMemo(
    () => ({
      ...
      noteTemplates,
      loadNoteTemplates,
      saveNoteTemplates: saveNoteTemplates2,
      loadingTemplates,
      createTemplate: createTemplate$1
    }),
    [
      config,
      loadConfig,
  ...
  return React$2.createElement(TrelloContext.Provider, { value }, children);
}
TrelloProvider.propTypes = {
  children: PropTypes.node.isRequired
};
function useTrello() {
  const context = reactExports.useContext(TrelloContext);
  if (!context) {
...
function Config({ onClose }) {
  ...
  const [form, setForm] = reactExports.useState(() => ({ ...INITIAL_CONFIG }));
  const [isSaving, setSaving] = reactExports.useState(false);
  const [templateImportStatus, setTemplateImportStatus] = reactExports.useState("idle");
  const [templateImportError, setTemplateImportError] = reactExports.useState(null);
  const [activeSection, setActiveSection] = reactExports.useState(null);
  reactExports.useEffect(() => {
    setForm((prev) => ({ ...prev, ...config }));
  }, [config]);
  const templateSourceLabel = reactExports.useMemo(() => {
    if (form.templateSourceType === "file") {
      const date = form.templateSourceUpdatedAt ? new Date(form.templateSourceUpdatedAt) : null;
      const formattedDate = date ? date.toLocaleString(void 0, {
        day: "2-digit",
        month: "2-digit",
        year: "numeric",
        hour: "2-digit",
      ...
      const labelSource = form.templateSourcePath || form.templateSourceName || "Arquivo";
  ...
  const templateCount = reactExports.useMemo(() => {
    if (loadingTemplates) {
      return null;
    }
    return (noteTemplates == null ? void 0 : noteTemplates.length) ?? 0;
  }, [loadingTemplates, noteTemplates]);
  const handleChange = reactExports.useCallback((field, value) => {
    setForm((prev) => ({ ...prev, [field]: value }));
  }, []);
  const validateTemplateEntry = reactExports.useCallback((entry, index) => {
    ...
    return { id: id2, label, notes };
  }, []);
  const handleTemplateFileSelected = reactExports.useCallback(
    (file) => {
      if (!file) {
      ...
      reader.onload = async (event) => {
        var _a2;
        try {
          const text = ((_a2 = event == null ? void 0 : event.target) == null ? void 0 : _a2.result) ?? "";
          ...
          const normalized = data.map(
            (entry, index) => validateTemplateEntry(entry, index)
          );
          await saveNoteTemplates2(normalized);
          const metadata = {
    ...
    [saveConfig, saveNoteTemplates2, validateTemplateEntry]
  );
  ...
  if (!activeSection) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-full w-full flex-col gap-6 p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col w-full gap-4", children: CONFIG_SECTIONS.map((section) => {
      const Icon = section.icon;
      return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "h-full w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            Icon ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-12 w-12 items-center justify-center rounded-xl bg-primary/10 text-primary transition group-hover:bg-primary group-hover:text-white dark:bg-primary/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-7 w-7" }) }) : null,
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex flex-col gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base font-semibold text-neutral-900 dark:text-neutral-50", children: section.label }),
              section.description ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-neutral-600 dark:text-neutral-300", children: section.description }) : null
            ] })
          ]
        }
      ) }, section.id);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full w-full flex-col overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center justify-between px-4 py-3 ", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-base font-semibold text-neutral-900 dark:text-neutral-50", children: ((_a = CONFIG_SECTIONS.find((section) => section.id === activeSection)) == null ? void 0 : _a.label) ?? "Configuração" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-16", "aria-hidden": "true" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto p-3", children: activeSection === "trello" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      TrelloConfigForm,
      {
        form,
